 ...
 * 退税全量名单（区分税地） Service
 */
public interface TaxTuishuiAllQfsdService {
    ...
    /** 分页查询 */
    PageResult<TaxTuishuiAllQfsd> queryAllList(TaxQueryRequest request);

    /** 查询全部（导出用） */
    List<TaxTuishuiAllQfsd> queryAllListForExport(TaxQueryRequest request);
}
